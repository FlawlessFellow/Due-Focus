...
const linkItems = [
    { id: 1, img: linkItem1, alt: 'time tracking image', href: '/time-tracking' },
    { id: 2, img: linkItem2, alt: 'engineering metrics', href: '/engineering-metrics' },
    { id: 3, img: linkItem3, alt: 'code quality ranking', href: '/code-quality-ranking' },
    { id: 4, img: linkItem4, alt: 'writing better code', href: '/writing-better-code' },
    { id: 5, img: linkItem5, alt: 'set realistic estimates', href: '/set-realistic-estimates' },
];
        ...
        <div className="bottom__link-panel">
            <div className="bottom__linkPanel-container">
                <div className="bottom__linkPanel-list">
                    {linkItems.map((el) => (
                        <a href={el.href} className="bottomPanel-linkItem" key={el.id}>
